...
echo "Verifying az cli account login"
az account show
...
# TODO - Moving to /mnt data disk, does this need to be on the root volume for some reason?
# export INSTALLERHOME=/home/$BOOTSTRAP_ADMIN_USERNAME/.openshift
